...
const Navbar: React.FC = () => {
  ...
  return (
    <div>
      <nav className="relative w-full flex items-center justify-between bg-purple-400 text-white py-2 md:px-12 px-4">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="absolute top-0 right-0 h-screen w-1/2 bg-purple-400 text-white z-40 px-4 py-2 font-Poppins">
          <div
