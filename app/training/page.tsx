...
const courseData = [
  ...
  {id: 4, title: 'LAMP Stack', tech: ['Linux', 'Apache', 'MySQL', 'PHP'], desc: 'Leverege LAMP Stack to design web app.', image: '/coursepage/eight.jpg'},
  {id: 5, title: 'Mobile App', tech: ['React Native', 'Node', 'Mongodb', 'Express'], desc: 'Design mobile apps for android and apple.', image: '/coursepage/three.jpg'},
  {id: 6, title: 'Python', tech: ['Python'], desc: 'Master Python by making 10 apps.', image: '/coursepage/three.jpg'},
  {id: 7, title: 'Backend Master', tech: ['Node', 'Django', 'Go','Spring Boot', 'System Design'], desc: 'Become a Expert Backend Master.', image: '/coursepage/six.jpg'},
  {id: 8, title: 'Frontend Master', tech: ['React', 'React Native', 'Angular', 'Fluter'], desc: 'Become a frontend wizard by desiging awwwards like website.', image: '/coursepage/one.jpg'},
