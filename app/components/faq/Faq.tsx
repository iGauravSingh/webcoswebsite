  ...
  return (
    ...
    <div className="container px-0 mx-auto sm:px-5">
        ...
        <div
            ...
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">Our platform works with your Idea to create your app that is most economical as well best performance.</p>
        </div>

        <div
            className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 sm:px-8 md:px-12 sm:py-8 sm:rounded-lg sm:shadow md:w-2/3">
            <h3 className="text-lg font-bold text-purple-500 sm:text-xl md:text-2xl">Do we offer training?</h3>
            <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">We offer best training in market and make our student work on live projects.</p>
        </div>
